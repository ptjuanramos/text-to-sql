...
class JsonFormattedSchema:
    ...
    def __init__(self, schema_type: str, schema_json: dict[str, str | list[Any] | Any]):
    ...
    def get_schema_text(self) -> str:
        ...
        text = f"{self.schema_type}: {name}\n"

        if self.schema_type.upper() == "TABLE":
            text += "Columns:\n"
        ...
        elif self.schema_type.upper() == "VIEW":
            text += "Query:\n"
